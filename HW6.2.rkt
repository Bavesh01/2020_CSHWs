...
#reader(lib "htdp-intermediate-reader.ss" "lang")((modname HW6.2) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
;exercise 1
...
;Returns the frequency of every word in a list as a list of numbers.
